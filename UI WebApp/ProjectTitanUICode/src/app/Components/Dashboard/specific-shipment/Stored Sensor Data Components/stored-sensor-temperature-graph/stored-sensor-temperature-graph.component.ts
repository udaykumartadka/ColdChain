...
@Component({
  selector: 'app-stored-sensor-temperature-graph',
  templateUrl: './stored-sensor-temperature-graph.component.html',
  styleUrls: ['./stored-sensor-temperature-graph.component.css']
})
export class StoredSensorTemperatureGraphComponent implements OnInit, AfterViewInit {
    ...
    this.datePickerConfig = Object.assign({},
  {
    ...
    .subscribe(beaconId => {
      ...
      .subscribe(res => {
        ...
        this.maxTemp = maxTempObject.temperature;
        this.MaxTempTime = maxTempObject.current_system_time;
        this.minTemp = minTempObject.temperature;
        this.MinTempTime = minTempObject.current_system_time;
        this.avgTemp = this._shipmentService.findAvgTemp(JSON.parse(this.LineChartData));
