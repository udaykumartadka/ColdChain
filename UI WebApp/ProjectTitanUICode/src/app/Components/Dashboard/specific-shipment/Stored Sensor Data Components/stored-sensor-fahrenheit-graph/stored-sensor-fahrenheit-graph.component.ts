...
@Component({
  selector: 'app-stored-sensor-fahrenheit-graph',
  templateUrl: './stored-sensor-fahrenheit-graph.component.html',
  styleUrls: ['./stored-sensor-fahrenheit-graph.component.css']
})
export class StoredSensorFahrenheitGraphComponent implements OnInit, AfterViewInit  {
