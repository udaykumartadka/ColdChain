...
@Component({
  selector: 'app-stored-sensor-humidity-graph',
  templateUrl: './stored-sensor-humidity-graph.component.html',
  styleUrls: ['./stored-sensor-humidity-graph.component.css']
})
export class StoredSensorHumidityGraphComponent implements OnInit, AfterViewInit {
 //  Date Range
 DateRange: string[] = [];
