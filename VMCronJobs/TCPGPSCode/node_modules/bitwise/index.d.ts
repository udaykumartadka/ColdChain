...
declare const _default: {
    ...
    buffer: {
        and: (buffer1: Buffer, buffer2: Buffer, isLooping?: boolean) => Buffer;
        create: (bits: import("./types").Bit[]) => Buffer;
        modify: (buffer: Buffer, bits: import("./types").Bit[], offset?: number) => void;
        nand: (buffer1: Buffer, buffer2: Buffer, isLooping?: boolean) => Buffer;
        nor: (buffer1: Buffer, buffer2: Buffer, isLooping?: boolean) => Buffer;
        not: (buffer: Buffer) => Buffer;
        or: (buffer1: Buffer, buffer2: Buffer, isLooping?: boolean) => Buffer;
        ...
        xnor: (buffer1: Buffer, buffer2: Buffer, isLooping?: boolean) => Buffer;
        xor: (buffer1: Buffer, buffer2: Buffer, isLooping?: boolean) => Buffer;
    };
    byte: {
