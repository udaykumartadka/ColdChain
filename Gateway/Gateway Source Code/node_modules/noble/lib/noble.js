...
Noble.prototype.onDiscover = function(uuid, address, addressType, connectable, advertisement, rssi) {
  ...
  // console.log("Discovered Peripherals : ", uuid, this._discoveredPeripheralUUids.indexOf(uuid))
  ...
  if (this._allowDuplicates || !previouslyDiscoverd) {
    ...
    this.emit('discover', peripheral); // LIB Function Editted as per custom requirement
